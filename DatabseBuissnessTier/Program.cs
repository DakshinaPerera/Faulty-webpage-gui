...
namespace DatabseBuissnessTier
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            host = new ServiceHost(typeof(BusinessServerImplimentation));
            ...
            host.AddServiceEndpoint(typeof(BuissnessTierInterface), tcp, "net.tcp://0.0.0.0:8200/DataBusinessService");
